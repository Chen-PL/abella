...
pure_command_wo_dot:
  ...
  | hhint APPLYS maybe_depth clearable TO apply_args
    { Types.Apply($3, $4, $6, [], $1, true) }
  | hhint APPLYS maybe_depth clearable TO apply_args WITH withs
    { Types.Apply($3, $4, $6, $8, $1, true) }
  | hhint APPLYS maybe_depth clearable apply_args
    { Types.Apply($3, $4, $5, [], $1, true) }
  | hhint APPLYS maybe_depth clearable apply_args WITH withs
    { Types.Apply($3, $4, $5, $7, $1, true) }
  | hhint APPLYS maybe_depth clearable WITH withs
    { Types.Apply($3, $4, [], $6, $1, true) }
  | hhint APPLYS maybe_depth clearable
